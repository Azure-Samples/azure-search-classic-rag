# NET quickstart for classic RAG in Azure AI Search
...
- An [Azure AI Search resource](https://learn.microsoft.com/azure/search/search-create-service-portal.md).
  - We recommend using the Basic tier or higher.
  - [Enable semantic ranking](https://learn.microsoft.com/azure/search/semantic-how-to-enable-disable.md).
...
1. Run the following query in [Search Explorer](https://learn.microsoft.com/azure/search/search-explorer.md) to test your index: `complimentary breakfast`.
...
1. In the `minimal-query` project of the sample repo, open the `Program.cs` file to view the first example.
